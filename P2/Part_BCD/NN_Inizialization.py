...
plt.plot(np.arange(0,1000),mse_train_none, label='None')
plt.plot(np.arange(0,1000),mse_train_xavier, label='Xavier')
plt.plot(np.arange(0,1000),mse_train_he, label = 'He')
plt.xlabel('Epochs')
plt.ylabel('Error')
plt.title('NN with different initializations')
plt.legend()
